...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(resource_path("icons/help.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.helpButton.setIcon(icon1)
        self.helpButton.setIconSize(QtCore.QSize(24, 24))
        self.helpButton.setObjectName("helpButton")
        self.searchLineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.searchLineEdit.setGeometry(QtCore.QRect(400, 10, 391, 31))
        font = QtGui.QFont()
        ...
        self.listClearButton.setGeometry(QtCore.QRect(760, 540, 31, 31))
        self.listClearButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.listClearButton.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(resource_path("icons/clear.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.listClearButton.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(resource_path("icons/add.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.remarkAddButton.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(resource_path("icons/remove.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.remarkRemoveButton.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(resource_path("icons/edit.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.remarkEditButton.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(resource_path("icons/copy.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.remarkCopyButton.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(resource_path("icons/document-save.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.fileSaveButton.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(resource_path("icons/tab-edit.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabEditButton.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(resource_path("icons/document-save-as.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.fileSaveAsButton.setIcon(icon11)
        ...
        self.line_2.setGeometry(QtCore.QRect(330, 10, 21, 31))
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(resource_path("icons/tab-new.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabAddButton.setIcon(icon12)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(resource_path("icons/tab-remove.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabRemoveButton.setIcon(icon13)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(resource_path("icons/document-revert.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.fileRevertButton.setIcon(icon14)
