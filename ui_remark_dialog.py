...
class Ui_RemarkDialog(object):
    def setupUi(self, RemarkDialog):
        ...
        self.tagsLineEdit = QtWidgets.QLineEdit(RemarkDialog)
        self.tagsLineEdit.setMinimumSize(QtCore.QSize(0, 32))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.tagsLineEdit.setFont(font)
        self.tagsLineEdit.setObjectName("tagsLineEdit")
        self.verticalLayout_2.addWidget(self.tagsLineEdit)
    ...
    def retranslateUi(self, RemarkDialog):
        ...
        self.tagsLineEdit.setPlaceholderText(_translate("RemarkDialog", "Теги (через запятую)"))
